...
def gamepage():
    ...
    reviews = review_repository_singleton.get_review_by_author(
...
def post_review(game_id):
    ...
    new_review = review_repository_singleton.create_review(
        current_user.user_id, current_game.game_id, current_game.release_date, user_rating, user_review)
